...
function trajectory_msgs_msg_JointTrajectory_deserialize(tvb, offset, encoding, tree, label)
    ...
    offset = sequence_deserialize(tvb, offset, encoding, subtree, "points:", trajectory_msgs_msg_JointTrajectoryPoint_deserialize)
